...
public class C03_RelativeLocator {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        }else System.out.println("Direk locate testi FAILED");
        ...
        //yukaridaki testte ilk urune tikladigimiz icin once urunlerin oldugu sayfaya gelelim
        driver.get("https://testotomasyonu.com/relativeLocators");
        Thread.sleep(2000);
        ...
        driver.findElement(RelativeLocator.with(By.id("pic7_thumb")).toRightOf(appleKulaklik)).click();
        ...
        // 2. relative locator icin Bat kualkligin altinda diyelim
        driver.get("https://testotomasyonu.com/relativeLocators");
        Thread.sleep(2000);
        ...
        driver.findElement(RelativeLocator.with(By.id("pictext7")).toLeftOf(motorTelefon)).click();

        urunIsimElementi = driver.findElement(By.xpath("//div[@class=' heading-sm mb-4']"));

        if (urunIsimElementi.getText().equals(expectedIsim)){
            System.out.println("3.relative locate testi PASSED");
        }else System.out.println("4.relative locate testi FAILED");
       ...
       // driver.findElement(RelativeLocator.with(By.id("pictext7")).toRightOf(appleKulaklik).below(batKulaklik).toLeftOf(motorTelefon)).click();
        /*
            Her ne kadar apple kulakligi locate etmis olsak da
            sonrasinda driver'i farkli sayfalara gonderdigimiz icin
            driver appleKulaklik icin "StateElementReferenceException" veriyor
        ...
        driver.findElement(RelativeLocator.with(By.id("pictext7"))
                ...
                .below(batKulaklik)
                .toLeftOf(motorTelefon)).click();

        urunIsimElementi = driver.findElement(By.xpath("//div[@class=' heading-sm mb-4']"));

        if (urunIsimElementi.getText().equals(expectedIsim)){
            System.out.println("4.relative locate testi PASSED");
        }else System.out.println("4.relative locate testi FAILED");
