...
public class C02_Locators {
    ...
    public static void main(String[] args) {
        ...
        if (islemBasliklariList.size()==expectedBaslikSayisi){
            ...
            System.out.println("Baslik sayisi testi FAILED");
        }

        // 5- Islem basliklari icinde “Pay Bills” oldugunu test edin

        // 1.yontem loop ile tum webElement'lerin uzerlerindeki yazilari alip
        //  olusturacagimiz bir string listeye koyabilir
        ...
        // bizden istenen Pay Bill'in oldugunu test etmemiz
