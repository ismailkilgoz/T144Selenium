...
public class C05_LocatorVeWebElementKullanimi {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // id'si id="global-search" olan webelement dedigimizde unique degere ulasiyoruz
        // locator olarak By.id() kullanabiliriz

        // locate etme, belirlenen adresi ve locator'i kullanarak
        // istenen web elementi icinde bulundugumuz class'dan kullanilabilir hale getirmektir.
